...
public class TagApiController {
    ...
    {
        return new SuccessResponse(HttpStatus.OK.value(), "모든 태그 목록 조회에 성공했습니다", tagReadService.readAll(pageRequest.of()));
    }
    ...
    public SuccessResponse delete (@PathVariable(value = "id") Long id) {
        ...
        return new SuccessResponse(HttpStatus.OK.value(), "성공적으로 태그를 삭제하였습니다.", tagDeleteService.delete(id));
    }
}
